...
DESCRIPTOR_DIR = Path("A:/aromatic/src/components/descriptors")
...
def draw_bounding_box(image, landmarks, color=(0, 255, 0), thickness=2):
    ...
    # Get min and max coordinates from landmarks
    ...
    with mp_face_mesh.FaceMesh(
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            for variant_name, variant_image in variants:
                ...
                # Print first 5 keypoints with their descriptors
                for i, (kp, desc) in enumerate(zip(keypoints[:5], descriptors[:5])):
                    ...
                    print(f"  Descriptor: {desc[:5]}...")  # Show first 5 values of descriptor
            ...
            # Save descriptors after processing all variations
